...
<head>
    <meta charset="UTF-8">
    <title>Panel Asisten - <?php echo $pageTitle ?? 'Dasbor'; ?></title>
    <style>
        body {
...
<div style="display:flex; min-height:100vh;">
    <aside class="classic-sidebar">
        ...
        <nav class="classic-nav">
            <ul>
                ...
                <li>
                    <a href="manage_courses.php" class="<?php echo ($activePage == 'manage_courses') ? $activeClass : $inactiveClass; ?>">
                ...
                <li>
                    <a href="manage_modules.php" class="<?php echo (isset($activePage) && $activePage == 'manage_modules') ? $activeClass : $inactiveClass; ?>">
                        ...
                        Kelola Modul
                        <span style="font-size:0.85rem; color:#adb5bd; margin-left:8px;">(via Praktikum)</span>
                    </a>
                </li>
                <li>
                    <a href="submitted_reports.php" class="<?php echo (isset($activePage) && $activePage == 'laporan') ? $activeClass : $inactiveClass; ?>">
                ...
                <li>
                    <a href="manage_users.php" class="<?php echo (isset($activePage) && $activePage == 'manage_users') ? $activeClass : $inactiveClass; ?>">
                        <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.7" viewBox="0 0 24 24"><circle cx="12" cy="7" r="4"/><path d="M5.5 21a7.5 7.5 0 0 1 13 0"/></svg>
                        Kelola Pengguna
                    </a>
                </li>
            </ul>
    ...
    <main class="classic-main">
        <header style="margin-bottom:32px;">
            ...
            <a href="../logout.php" class="logout-btn hover:logout-btn text-white font-bold py-2 px-4 rounded-lg transition-colors duration-300">
                Keluar
            </a>
        </header>